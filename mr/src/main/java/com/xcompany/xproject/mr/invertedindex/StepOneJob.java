...
public class StepOneJob extends Configured implements Tool {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(StepOneJob.class);

	public static void main(String[] args) throws Exception {
		
		Date startTime = new Date();
		LOGGER.info("==========job started: " + startTime);
		int res = ToolRunner.run(new Configuration(), new StepOneJob(), args);
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(StepOneJob.class);
