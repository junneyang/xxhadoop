...
public class StepTwoJob extends Configured implements Tool {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(StepTwoJob.class);

	public static void main(String[] args) throws Exception {
		
		Date startTime = new Date();
		LOGGER.info("==========job started: " + startTime);
		int res = ToolRunner.run(new Configuration(), new StepTwoJob(), args);
